            ...
            if(!skip){
                ...
                if(!skip){
                    ...
                    if(sources[j].type === "feed"){
                        ...
                        page += "var berlin_map = L.map('mapid').setView([((52.6854-52.3348)/2+52.3348), ((13.7607-13.0847)/2+13.0847)], 12);"+"\n"+
                                "var moabit_map = L.map('mapid').setView([((52.540971446408086-52.51303464932938)/2+52.51303464932938), ((13.349504470825195-13.306503295898438)/2+13.306503295898438)], 12);"+"\n"+
                        ...
                        page += "var moabit_map = L.map('mapid').setView([((52.540971446408086-52.51303464932938)/2+52.51303464932938), ((13.349504470825195-13.306503295898438)/2+13.306503295898438)], 12);"+"\n"+
                                "var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';"+"\n"+
                                "var osmAttrib='Map data © <a href=\'http://openstreetmap.org\'>OpenStreetMap</a> contributors';"+"\n"+
                                "var osm = new L.TileLayer(osmUrl, {attribution: osmAttrib});"+"\n"+
                                "osm.addTo(moabit_map);"+"\n"+
